...
public class MockJedis extends Jedis {
  ...
  public Set<String> zrevrange(String key, long start, long end) {
    return pipeline.zrevrange(key, start, end).get();
  }
  ...
  public Set<Tuple> zrangeByScoreWithScores(String key, double min, double max) {
    return pipeline.zrangeByScoreWithScores(key, min, max).get();
  }
  ...
  public Set<String> zrevrangeByScore(String key, double max, double min) {
    return pipeline.zrevrangeByScore(key, max, min).get();
  }
  ...
  public Set<Tuple> zrevrangeByScoreWithScores(String key, double max, double min) {
    return pipeline.zrevrangeByScoreWithScores(key, max, min).get();
  }
